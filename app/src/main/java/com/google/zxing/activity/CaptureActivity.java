...
import com.merchant.drifting.util.BitmapUtil;
import com.merchant.drifting.util.ScreenUtil;
...
public class CaptureActivity extends AppCompatActivity implements Callback {
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (result != null) {
                    ...
                    bundle.putString(MDConstant.INTENT_EXTRA_KEY_QR_SCAN, result.getText());
    ...
    public void handleDecode(Result result, Bitmap barcode) {
        ...
        if (TextUtils.isEmpty(resultString)) {
            ...
            Intent resultIntent = new Intent();
            Bundle bundle = new Bundle();
            bundle.putString(MDConstant.INTENT_EXTRA_KEY_QR_SCAN, resultString);
