...
public final class StorageUtil {
    ...
    public static File getTrueCacheDirectory(Context context) {
        return getTrueCacheDirectory(context, true);
    }
    ...
    public static File getTrueCacheDirectory(Context context, boolean preferExternal) {
        File appCacheDir = null;
        String externalStorageState;
        try {
            externalStorageState = Environment.getExternalStorageState();
        ...
        if (preferExternal && MEDIA_MOUNTED.equals(externalStorageState) && hasExternalStoragePermission(context)) {
            appCacheDir = getExternalTrueCacheDir(context);
        }
        if (appCacheDir == null) {
    ...
    private static File getExternalTrueCacheDir(Context context) {
        File dataDir = new File(new File(Environment.getExternalStorageDirectory(), "Android"), "data");
