...
public interface AddItemContract {
    ...
    interface View extends IView {
        ...
        void OnGoodsAddSuccess();

        void OnGoodsInfoSuccess(GoodsInfoEntity entity);

        void OnGoodsEditSuccess();
    ...
    interface Model extends IModel {
        Observable<BaseEntity> goodsadd(MultipartBody shortVoice);

        Observable<BaseEntity<GoodsInfoEntity>> goodsinfo(String shop_id, String sku_code);

        Observable<BaseEntity> goodsedit(MultipartBody shortVoice);
