...
public interface AddBankCardActivityContract {
    ...
    interface Model extends IModel {
        Observable<BaseEntity> bankadd( String shopid, String name, String bank_name, String branch_name, String card_no, String mobile, String code);
