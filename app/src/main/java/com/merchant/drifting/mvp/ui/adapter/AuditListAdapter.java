...
public class AuditListAdapter extends IndicatorViewPager.IndicatorFragmentPagerAdapter {

    private List<ApplicationRecordEntity> mChannelDatas = new ArrayList<>();//频道标题信息


    public AuditListAdapter(FragmentManager fm) {
        super(fm);
    }
    ...
    public Fragment getFragmentForPage(int position) {
        return AuditListPagerFragment.newInstance(mChannelDatas.get(position).getType());
    }
