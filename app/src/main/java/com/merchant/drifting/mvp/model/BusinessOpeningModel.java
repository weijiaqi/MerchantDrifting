 ...
 */
@ActivityScope
public class BusinessOpeningModel extends BaseModel implements BusinessOpeningContract.Model{
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public BusinessOpeningModel(IRepositoryManager repositoryManager) {
    ...
    @Override
    public Observable<BaseEntity<LoginEntity>> register(String mobile, String code) {
        return mRepositoryManager.obtainRetrofitService(ApiService.class).register(mobile,code);
    }
}