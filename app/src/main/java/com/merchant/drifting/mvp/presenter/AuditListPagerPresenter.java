 ...
 */
@FragmentScope
public class AuditListPagerPresenter extends BasePresenter<AuditListPagerContract.Model, AuditListPagerContract.View> {
    @Inject
    ...
    @Inject
    public AuditListPagerPresenter(AuditListPagerContract.Model model, AuditListPagerContract.View rootView) {
     ...
     * 审核列表
     */
    public void shopapplyLog(String shop_id,   int status) {
        if (mRootView != null) {
