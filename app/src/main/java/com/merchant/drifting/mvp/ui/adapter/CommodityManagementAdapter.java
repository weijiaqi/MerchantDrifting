...
public class CommodityManagementAdapter extends IndicatorViewPager.IndicatorFragmentPagerAdapter {

    private List<ApplicationRecordEntity> mChannelDatas = new ArrayList<>();//频道标题信息


    public CommodityManagementAdapter(FragmentManager fm) {
        super(fm);
    }
    ...
    public Fragment getFragmentForPage(int position) {
        return CommodityManagerFragment.newInstance(mChannelDatas.get(position).getType());
    }
