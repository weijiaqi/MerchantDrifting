...
public interface OrderContract {
    ...
    interface View extends IView {
        ...
        void onWriteOffListSuccess(WriteOffListEntity entity, boolean isNotData);
    ...
    interface Model extends IModel {
        Observable<BaseEntity<WriteOffListEntity>> writeOffList(String shop_id, int page, int limit);
    }
}