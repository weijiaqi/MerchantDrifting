 ...
 */
@FragmentScope
public class AuditListPagerModel extends BaseModel implements AuditListPagerContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public AuditListPagerModel(IRepositoryManager repositoryManager) {
