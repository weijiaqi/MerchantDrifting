 ...
 * ================================================
 */
public interface AuditListPagerContract {
    ...
    interface View extends IView {
        ...
        void OnAuditingSuccess(List<AuditingEntity> list);
    ...
    interface Model extends IModel {
        Observable<BaseEntity<List<AuditingEntity>>> auditing(String shop_id,  int audit);
    }
}