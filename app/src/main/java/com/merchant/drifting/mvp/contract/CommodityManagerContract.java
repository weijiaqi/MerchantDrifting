 ...
 * ================================================
 */
public interface CommodityManagerContract {
    ...
    interface View extends IView {
        ...
        void OnGoodsListSuccess(List<GoodsListEntity> list);
    ...
    interface Model extends IModel {
        Observable<BaseEntity<List<GoodsListEntity>>> goodslist(String shop_id, int selling);
    }
}