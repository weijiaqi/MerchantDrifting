...
public class ProgressBarCircular extends View {
    private static final String TAG = ProgressBarCircular.class.getSimpleName();
    ...
    /**
     * The constructor for the ProgressBarCircular
     */
    public ProgressBarCircular(Context context, AttributeSet attrs) {
        super(context, attrs);

        parseAttributes(context.obtainStyledAttributes(attrs, R.styleable.ProgressBarCircular));
...
//    invalidate();
    ...
    private void parseAttributes(TypedArray a) {
        ...
        circleRadius = (int) a.getDimension(R.styleable.ProgressBarCircular_matProg_circleRadius, circleRadius);

        fillRadius = a.getBoolean(R.styleable.ProgressBarCircular_matProg_fillRadius, false);

        barWidth = (int) a.getDimension(R.styleable.ProgressBarCircular_matProg_barWidth, barWidth);

        rimWidth = (int) a.getDimension(R.styleable.ProgressBarCircular_matProg_rimWidth, rimWidth);

        float baseSpinSpeed =
                a.getFloat(R.styleable.ProgressBarCircular_matProg_spinSpeed, spinSpeed / 360.0f);
        spinSpeed = baseSpinSpeed * 360;

        barSpinCycleTime =
                a.getInt(R.styleable.ProgressBarCircular_matProg_barSpinCycleTime, (int) barSpinCycleTime);

        barColor = a.getColor(R.styleable.ProgressBarCircular_matProg_barColor, barColor);

        rimColor = a.getColor(R.styleable.ProgressBarCircular_matProg_rimColor, rimColor);

        linearProgress = a.getBoolean(R.styleable.ProgressBarCircular_matProg_linearProgress, false);

        if (a.getBoolean(R.styleable.ProgressBarCircular_matProg_progressIndeterminate, false)) {
            spin();
        }
