...
import com.merchant.drifting.di.module.OrderDataModule;
 ...
 */
@ActivityScope
@Component(modules = OrderDataModule.class,dependencies = AppComponent.class)
public interface OrderDataComponent {

    void inject(OrderDataActivity activity);


    @Component.Builder
    interface Builder {
        @BindsInstance
        Builder view(OrderDataContract.View view);

        Builder appComponent(AppComponent appComponent);

        OrderDataComponent build();
    }
}