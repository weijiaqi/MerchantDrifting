...
import com.merchant.drifting.di.module.BankCardManagementModule;
 ...
 */
@ActivityScope
@Component(modules = BankCardManagementModule.class, dependencies = AppComponent.class)
public interface BankCardManagementComponent {

    void inject(BankCardManagementActivity activity);
